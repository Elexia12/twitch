...
// Llamada al api de twitch para que revise los comentarios a ver si alguno pego
...
var main = async function mainFunction() {
  ...
  getPokemon();
  setTimeout(() => showPokemon(), 5500);
}

//Cambiar a revisar si el usuario adivino bien y guardar un contador de cuantas buenas tiene para regalar un sub a las 3
function checkGuess() {
  ...
  // Agregar timer acorde al anuncio para 
